...
\begin{center}
\textbf{\Huge Rift HyperBridge}
\end{center}

\begin{center}
\section*{Enabling Trustless Swaps Between Bitcoin and Ethereum}
\end{center}
\vspace*{\baselineskip}

\begin{center}
{Cliff Syner{~~~~~~~~~~~~~~}Tristan Barrett{~~~~~~~~~~~~}Samee Siddiqui}
\end{center}

\begin{center}
{cliff@rift.exchange{~~~~~}tristan@rift.exchange{~~~~~}samee@rift.exchange}
\end{center}
...
Buyer paid an arbitrary number of Liquidity Providers (LPs}{)
...
\hspace*{4em}{\includegraphics[width=5in]{images/image4.png}}
{}\vspace*{\baselineskip}
...
\hspace*{1em}{\includegraphics[width=5.5in]{images/image2.png}}
{}\vspace*{\baselineskip}
